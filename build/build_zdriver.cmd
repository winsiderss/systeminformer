...
msbuild KSystemInformer\KSystemInformer.sln -t:%BUILD_TARGET% -p:Configuration=%BUILD_CONFIGURATION%;Platform=x64 -maxCpuCount -terminalLogger:false -consoleLoggerParameters:Summary;Verbosity=detailed %PREFAST_ANALYSIS%
if %ERRORLEVEL% neq 0 goto end

msbuild KSystemInformer\KSystemInformer.sln -t:%BUILD_TARGET% -p:Configuration=%BUILD_CONFIGURATION%;Platform=ARM64 -maxCpuCount -terminalLogger:false -consoleLoggerParameters:Summary;Verbosity=detailed %PREFAST_ANALYSIS%
if %ERRORLEVEL% neq 0 goto end
