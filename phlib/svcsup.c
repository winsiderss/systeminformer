    ...
    )
{
    ...
    if (!Type)
    {
        ...
        {
            Type = WindowsVersion >= WINDOWS_10 ? SERVICE_WIN32 | 
                SERVICE_ADAPTER |  SERVICE_DRIVER | 
                SERVICE_INTERACTIVE_PROCESS |  SERVICE_USER_SERVICE | 
                SERVICE_USERSERVICE_INSTANCE : (SERVICE_DRIVER | SERVICE_WIN32);
        }
        else
        {
