...
BOOLEAN PhInitializeImports()
{
    ...
    InitProcReq("ntdll.dll", NtExtendSection);
    ...
    InitProcReq("ntdll.dll", NtOpenSection);
    InitProcReq("ntdll.dll", NtOpenThread);
    InitProcReq("ntdll.dll", NtOpenThreadToken);
    ...
    InitProcReq("ntdll.dll", NtQueryEvent);
    ...
    InitProcReq("ntdll.dll", NtUnmapViewOfSection);
