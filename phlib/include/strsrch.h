...
typedef enum _PH_STRING_SEARCH_ENCODING
{
    PH_STRING_SEARCH_ENCODING_ANSI,
    PH_STRING_SEARCH_ENCODING_UTF8,
    PH_STRING_SEARCH_ENCODING_UTF16
} PH_STRING_SEARCH_ENCODING, *PPH_STRING_SEARCH_ENCODING;
