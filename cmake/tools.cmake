...
set(SI_CUSTOM_BUILD_TOOL "${SYSTEM_INFORMER_ROOT}/tools/CustomBuildTool/bin/Release/$ENV{PROCESSOR_ARCHITECTURE}/CustomBuildTool.exe")
...
function(si_sdkbuild target)
    add_custom_command(
        ...
        WORKING_DIRECTORY "${SYSTEM_INFORMER_ROOT}"
        VERBATIM
    )
endfunction()
