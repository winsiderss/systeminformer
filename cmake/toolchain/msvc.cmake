...
macro(_si_set_init _suffix)
    set(__joined)
    list(JOIN SI_${_suffix} " " __joined)
    set(CMAKE_${_suffix} "${__joined}")
endmacro()

_si_set_init(C_FLAGS_INIT)
_si_set_init(C_FLAGS_DEBUG_INIT)
_si_set_init(C_FLAGS_RELEASE_INIT)
_si_set_init(CXX_FLAGS_INIT)
_si_set_init(CXX_FLAGS_DEBUG_INIT)
_si_set_init(CXX_FLAGS_RELEASE_INIT)
_si_set_init(EXE_LINKER_FLAGS_INIT)
_si_set_init(EXE_LINKER_FLAGS_DEBUG_INIT)
_si_set_init(EXE_LINKER_FLAGS_RELEASE_INIT)
_si_set_init(SHARED_LINKER_FLAGS_INIT)
_si_set_init(SHARED_LINKER_FLAGS_DEBUG_INIT)
_si_set_init(SHARED_LINKER_FLAGS_RELEASE_INIT)
_si_set_init(MODULE_LINKER_FLAGS_INIT)
_si_set_init(MODULE_LINKER_FLAGS_DEBUG_INIT)
_si_set_init(MODULE_LINKER_FLAGS_RELEASE_INIT)
