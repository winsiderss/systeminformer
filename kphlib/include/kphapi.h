...
typedef struct _KPH_INFORMER_SETTINGS
{
    union
    {
        ...
        struct
        {
            ...
            ULONG64 ProcessHandlePreCreate : 1;
            ULONG64 ProcessHandlePostCreate : 1;
            ULONG64 ProcessHandlePreDuplicate : 1;
            ULONG64 ProcessHandlePostDuplicate : 1;
            ULONG64 ThreadHandlePreCreate : 1;
            ULONG64 ThreadHandlePostCreate : 1;
            ULONG64 ThreadHandlePreDuplicate : 1;
            ULONG64 ThreadHandlePostDuplicate : 1;
            ULONG64 DesktopHandlePreCreate : 1;
            ULONG64 DesktopHandlePostCreate : 1;
