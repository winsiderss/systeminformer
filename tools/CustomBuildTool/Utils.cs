...
using static CustomBuildTool.VisualStudio;
...
namespace CustomBuildTool
{
    public static partial class Win32
    {
        ...
        private static partial uint RegOpenKeyExW(IntPtr RootKeyHandle, string KeyName, uint Options, uint AccessMask, out IntPtr KeyHandle);
        [LibraryImport("advapi32.dll", StringMarshalling = StringMarshalling.Utf16)]
        private static partial uint RegQueryValueExW(IntPtr KeyHandle, string ValueName, IntPtr Reserved, out int DataType, IntPtr DataBuffer, ref int DataLength);
        [LibraryImport("advapi32.dll")]
        private static partial uint RegCloseKey(IntPtr KeyHandle);
...
#pragma warning restore SYSLIB0041 // Type or member is obsolete
    ...
    public static class VisualStudio
    {
        ...
        //        catch (Exception ex)
        //        {
        //            Program.PrintColorMessage("[ERROR:GetVisualStudioInstance] " + ex, ConsoleColor.Red);
        //        }
        //
        ...
        //            else
        //            {
        //                Program.PrintColorMessage($"[SKIP] {instance.DisplayName} does not have required the packages: ", ConsoleColor.Yellow);
    ...
    //    [return: MarshalAs(UnmanagedType.BStr)] string GetDisplayName([In] int lcid = 0);
    //    [return: MarshalAs(UnmanagedType.BStr)] string GetDescription([In] int lcid = 0);
    //    [return: MarshalAs(UnmanagedType.BStr)] string ResolvePath([In] string pwszRelativePath = null);
    //}
    ...
    //    [return: MarshalAs(UnmanagedType.BStr)] string GetInstallationPath();
    //    [return: MarshalAs(UnmanagedType.BStr)] string GetInstallationVersion();
    //    [return: MarshalAs(UnmanagedType.BStr)] string GetDisplayName([MarshalAs(UnmanagedType.U4)][In] int lcid = 0);
    //    [return: MarshalAs(UnmanagedType.BStr)] string GetDescription([MarshalAs(UnmanagedType.U4)][In] int lcid = 0);
    //    [return: MarshalAs(UnmanagedType.BStr)] string ResolvePath([MarshalAs(21)][In] string pwszRelativePath = null);
    ...
    //    [return: MarshalAs(UnmanagedType.BStr)] string GetEnginePath();
    //}
