    ...
    )
{
    ...
    {
        SIP(L"", SMBIOS_SYSTEM_BOOT_STATUS_NO_ERROR),
        SIP(L"", SMBIOS_SYSTEM_BOOT_STATUS_NO_BOOTABLE_MEDIA),
        SIP(L"", SMBIOS_SYSTEM_BOOT_STATUS_OPERATING_SYSTEM_FAILED_TO_LOAD),
        SIP(L"", SMBIOS_SYSTEM_BOOT_STATUS_FIRMWARE_DETECTED_HARDWARE_FAILURE),
        SIP(L"", SMBIOS_SYSTEM_BOOT_STATUS_OPERATING_SYSTEM_DETECTED_FAILURE),
        SIP(L"", SMBIOS_SYSTEM_BOOT_STATUS_USER_REQUESTED_BOOT),
        SIP(L"", SMBIOS_SYSTEM_BOOT_STATUS_SECURITY_VIOLATION),
        SIP(L"", SMBIOS_SYSTEM_BOOT_STATUS_PREVIOUS_REQUESTED_IMAGE),
        SIP(L"", SMBIOS_SYSTEM_BOOT_STATUS_WATCHDOG_EXPIRED),
    };
