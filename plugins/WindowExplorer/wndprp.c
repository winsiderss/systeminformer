    ...
    )
{
    ...
    lvItemIndex = PhAddListViewItem(context->PropsListViewHandle, MAXINT, value, NULL);
    ...
    if (IS_INTRESOURCE(Name)) // This is an integer atom.
    {
        ...
        PhSetListViewSubItem(context->PropsListViewHandle, lvItemIndex, 1, propName->Buffer);
