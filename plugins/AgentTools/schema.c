...
CONST AT_TOOL AtTools[] =
{
    ...
    },
    {
        ...
        "\"system_call_disable\":{\"type\":[\"object\",\"null\"],\"properties\":{\"audit_disallow_win32k_system_calls\":{\"type\":\"boolean\"},\"disallow_win32k_system_calls\":{\"type\":\"boolean\"}}},"
        "\"extension_point_disable\":{\"type\":[\"object\",\"null\"],\"properties\":{\"disable_extension_points\":{\"type\":\"boolean\"}},\"description\":\"Blocks legacy extension point DLL injection\"},"
        "\"control_flow_guard\":{\"type\":[\"object\",\"null\"],\"properties\":{\"enable_xfg\":{\"type\":\"boolean\"},\"enable_xfg_audit_mode\":{\"type\":\"boolean\"},\"enabled\":{\"type\":\"boolean\"},\"export_suppression\":{\"type\":\"boolean\"},\"strict_mode\":{\"type\":\"boolean\"}},\"description\":\"Includes enable_xfg and its audit mode\"},"
        "\"binary_signature\":{\"type\":[\"object\",\"null\"],\"properties\":{\"audit_microsoft_signed_only\":{\"type\":\"boolean\"},\"audit_store_signed_only\":{\"type\":\"boolean\"},\"microsoft_signed_only\":{\"type\":\"boolean\"},\"mitigation_opt_in\":{\"type\":\"boolean\"},\"store_signed_only\":{\"type\":\"boolean\"}},\"description\":\"microsoft_signed_only means the process will not load unsigned code\"},"
        "\"image_load\":{\"type\":[\"object\",\"null\"],\"properties\":{\"audit_no_low_mandatory_label_images\":{\"type\":\"boolean\"},\"audit_no_remote_images\":{\"type\":\"boolean\"},\"no_low_mandatory_label_images\":{\"type\":\"boolean\"},\"no_remote_images\":{\"type\":\"boolean\"},\"prefer_system32_images\":{\"type\":\"boolean\"}}},"
        "\"payload_restriction\":{\"type\":[\"object\",\"null\"],\"properties\":{\"audit_export_address_filter\":{\"type\":\"boolean\"},\"audit_export_address_filter_plus\":{\"type\":\"boolean\"},\"audit_import_address_filter\":{\"type\":\"boolean\"},\"audit_rop_caller_check\":{\"type\":\"boolean\"},\"audit_rop_sim_exec\":{\"type\":\"boolean\"},\"audit_rop_stack_pivot\":{\"type\":\"boolean\"},\"enable_export_address_filter\":{\"type\":\"boolean\"},\"enable_export_address_filter_plus\":{\"type\":\"boolean\"},\"enable_import_address_filter\":{\"type\":\"boolean\"},\"enable_rop_caller_check\":{\"type\":\"boolean\"},\"enable_rop_sim_exec\":{\"type\":\"boolean\"},\"enable_rop_stack_pivot\":{\"type\":\"boolean\"}},\"description\":\"Export and import address filtering and ROP defences\"},"
        "\"child_process\":{\"type\":[\"object\",\"null\"],\"properties\":{\"allow_secure_process_creation\":{\"type\":\"boolean\"},\"audit_no_child_process_creation\":{\"type\":\"boolean\"},\"no_child_process_creation\":{\"type\":\"boolean\"}}},"
        "\"side_channel_isolation\":{\"type\":[\"object\",\"null\"],\"properties\":{\"smt_branch_target_isolation\":{\"type\":\"boolean\"}}},"
        "\"user_shadow_stack\":{\"type\":[\"object\",\"null\"],\"properties\":{\"audit_block_non_cet_binaries\":{\"type\":\"boolean\"},\"audit_set_context_ip_validation\":{\"type\":\"boolean\"},\"audit_user_shadow_stack\":{\"type\":\"boolean\"},\"block_non_cet_binaries\":{\"type\":\"boolean\"},\"block_non_cet_binaries_non_ehcont\":{\"type\":\"boolean\"},\"enable_user_shadow_stack\":{\"type\":\"boolean\"},\"enable_user_shadow_stack_strict_mode\":{\"type\":\"boolean\"},\"set_context_ip_validation\":{\"type\":\"boolean\"}},\"description\":\"CET; enable_user_shadow_stack is the one that matters\"},"
        "\"redirection_trust\":{\"type\":[\"object\",\"null\"],\"properties\":{\"audit_redirection_trust\":{\"type\":\"boolean\"},\"enforce_redirection_trust\":{\"type\":\"boolean\"}}}"
        "}},"
        AT_SNAPSHOT_SCHEMA
    ...
    },
    {
        ...
        "\"groups\":{\"type\":[\"array\",\"null\"],\"description\":\"Null when the token's groups could not be read, which is not the same as holding none\",\"items\":{\"type\":\"object\",\"properties\":{"
        ...
        "},\"required\":[\"sid\",\"flags\"]}},"
        "\"privileges\":{\"type\":[\"array\",\"null\"],\"description\":\"Null when the token's privileges could not be read, which is not the same as holding none\",\"items\":{\"type\":\"object\",\"properties\":{"
        "\"name\":{\"type\":[\"string\",\"null\"]},"
    ...
    },
    {
        ...
        "\"inputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"path\":{\"type\":\"string\",\"description\":\"Absolute Win32 path of the file to ask about, beginning with a drive letter\"},"
    ...
    },
    {
        ...
        "\"mode_flags\":{\"type\":[\"array\",\"null\"],\"items\":{\"type\":\"string\"},\"description\":\"synchronous_io_nonalert, delete_on_close, ...\"},"
        "\"position\":{\"type\":[\"integer\",\"null\"],\"description\":\"Current byte offset\"},"
        ...
        "\"section\":{\"type\":[\"object\",\"null\"],\"description\":\"Section handles only\",\"properties\":{"
        "\"size\":{\"type\":[\"integer\",\"null\"]},"
        "\"base_address\":{\"type\":[\"string\",\"null\"]},"
        ...
        "\"maximum_stack_size\":{\"type\":\"integer\"},\"contains_code\":{\"type\":\"boolean\"},"
        "\"dynamically_relocated\":{\"type\":\"boolean\"},\"dotnet_il_only\":{\"type\":\"boolean\"}}}}},"
        "\"process\":{\"type\":[\"object\",\"null\"],\"description\":\"Process handles only\",\"properties\":{"
        ...
        "\"create_time\":{\"type\":[\"string\",\"null\"]},\"exit_time\":{\"type\":[\"string\",\"null\"]}}},"
        "\"thread\":{\"type\":[\"object\",\"null\"],\"description\":\"Thread handles only\",\"properties\":{"
        "\"tid\":{\"type\":\"integer\"},\"pid\":{\"type\":\"integer\"},"
        "\"name\":{\"type\":[\"string\",\"null\"]},"
        "\"terminated\":{\"type\":[\"boolean\",\"null\"]},"
        "\"create_time\":{\"type\":[\"string\",\"null\"]}}},"
        "\"etw_registration\":{\"type\":[\"object\",\"null\"],\"description\":\"ETW registration handles only, driver only\",\"properties\":{"
    ...
    },
    {
        ...
        AT_SENSITIVE_NOTE AT_UNTRUSTED_NOTE AT_PAGE_NOTE "\","
        "\"inputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"path\":{\"type\":\"string\",\"description\":\"Absolute Win32 path of a file, beginning with a drive letter; reports every process mapping it\"},"
    ...
    },
    {
        ...
        "\"path\":{\"type\":\"string\",\"description\":\"Resolve against this file instead: an absolute Win32 path beginning with a drive letter\"},"
    ...
    },
    {
        ...
        "\"description\":\"Changes how a service starts and what it says about itself: its start type, whether an "
        "automatic start is delayed, and its description. At least one of start_type, delayed_auto_start and "
        "description is required, and any combination is applied in that order - if one step fails the earlier "
        "ones have already happened, so read the answer rather than assuming all or nothing. The description is "
        "the text the Services console shows and nothing depends on it; changing it does not change what the "
        "service does, and an empty string clears it. Every field in the answer is read back from the service "
        "manager rather than echoed. " AT_SERVICE_WRITE_NOTE "\","
        "\"inputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"name\":{\"type\":\"string\",\"description\":\"Service name from list_services\"},"
        "\"start_type\":{\"type\":\"string\",\"enum\":[\"boot\",\"system\",\"auto\",\"demand\",\"disabled\"]},"
        "\"delayed_auto_start\":{\"type\":\"boolean\",\"description\":\"Only means anything for an automatic service\"},"
        "\"description\":{\"type\":\"string\",\"maxLength\":1024,\"description\":\"What the Services console shows; an empty string clears it\"}"
        "},\"required\":[\"name\"],\"additionalProperties\":false},"
        "\"outputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"name\":{\"type\":\"string\"},"
        "\"display_name\":{\"type\":[\"string\",\"null\"]},"
    ...
    },
    {
        ...
        "\"rect\":{\"type\":[\"object\",\"null\"],\"properties\":{\"bottom\":{\"type\":\"integer\"},\"height\":{\"type\":\"integer\"},\"left\":{\"type\":\"integer\"},\"right\":{\"type\":\"integer\"},\"top\":{\"type\":\"integer\"},\"width\":{\"type\":\"integer\"}}},"
        "\"client_rect\":{\"type\":[\"object\",\"null\"],\"properties\":{\"bottom\":{\"type\":\"integer\"},\"height\":{\"type\":\"integer\"},\"left\":{\"type\":\"integer\"},\"right\":{\"type\":\"integer\"},\"top\":{\"type\":\"integer\"},\"width\":{\"type\":\"integer\"}}},"
        "\"restore_rect\":{\"type\":[\"object\",\"null\"],\"properties\":{\"bottom\":{\"type\":\"integer\"},\"height\":{\"type\":\"integer\"},\"left\":{\"type\":\"integer\"},\"right\":{\"type\":\"integer\"},\"top\":{\"type\":\"integer\"},\"width\":{\"type\":\"integer\"}},\"description\":\"Where the window returns to when restored\"},"
        "\"style\":{\"type\":\"string\",\"description\":\"Raw window style, hex\"},"
        "\"extended_style\":{\"type\":\"string\"},"
        "\"styles\":{\"type\":\"object\",\"properties\":{\"border\":{\"type\":\"boolean\"},\"caption\":{\"type\":\"boolean\"},\"child\":{\"type\":\"boolean\"},\"clip_children\":{\"type\":\"boolean\"},\"clip_siblings\":{\"type\":\"boolean\"},\"disabled\":{\"type\":\"boolean\"},\"group\":{\"type\":[\"boolean\",\"null\"]},\"maximize_box\":{\"type\":\"boolean\"},\"maximized\":{\"type\":\"boolean\"},\"minimize_box\":{\"type\":\"boolean\"},\"minimized\":{\"type\":\"boolean\"},\"popup\":{\"type\":\"boolean\"},\"sizing_frame\":{\"type\":\"boolean\"},\"system_menu\":{\"type\":\"boolean\"},\"tab_stop\":{\"type\":[\"boolean\",\"null\"]},\"visible\":{\"type\":\"boolean\"}},\"description\":\"Decoded window styles; null members do not apply to this kind of window\"},"
        "\"extended_styles\":{\"type\":\"object\",\"properties\":{\"accept_files\":{\"type\":\"boolean\"},\"app_window\":{\"type\":\"boolean\"},\"client_edge\":{\"type\":\"boolean\"},\"layered\":{\"type\":\"boolean\"},\"mdi_child\":{\"type\":\"boolean\"},\"no_activate\":{\"type\":\"boolean\"},\"no_redirection_bitmap\":{\"type\":\"boolean\"},\"tool_window\":{\"type\":\"boolean\"},\"topmost\":{\"type\":\"boolean\"},\"transparent\":{\"type\":\"boolean\"}}},"
    ...
    },
    {
        ...
        "\"status\":{\"type\":\"string\",\"description\":\"success, timed_out, destination_host_unreachable, ttl_expired_in_transit and so on; unknown when the failure is not an ICMP status, in which case read status_code\"},"
        "\"status_code\":{\"type\":\"string\",\"description\":\"The raw ICMP status or, when the request never left, the last error\"},"
    ...
    },
    {
        ...
        "\"engines\":{\"type\":[\"array\",\"null\"],\"description\":\"Null when the adapter would not report its node count, which is not the same as an adapter with no engines\",\"items\":{\"type\":\"object\",\"properties\":{"
    ...
    },
    {
        ...
        "\"shared_memory_limit_bytes\":{\"type\":[\"integer\",\"null\"]},"
        "\"engines\":{\"type\":[\"array\",\"null\"],\"description\":\"One entry per engine the adapter reports. Null when the adapter would not report its node count, which is not the same as an adapter with no engines\",\"items\":{\"type\":\"object\",\"properties\":{"
    ...
    },
    {
        ...
        "\"description\":\"Lists what is configured to run or load without anyone starting it: the registry Run/RunOnce "
        "keys (machine and current user, including the 32-bit view), the Startup folders, the Winlogon "
        "Shell/Userinit/Taskman values and its Notify handlers, Image File Execution Options debuggers, AppInit_DLLs, "
        "the LSA authentication/notification/security packages, KnownDLLs, print monitors, Explorer shell hooks and "
        "browser helper objects, and Active Setup stub commands. This is where persistence commonly hides. Each entry "
        "carries the file it points at (image_path) and whether that file is there (image_exists); ask for verify to "
        "add its signature (verify_result, verify_signer). An entry naming a file that is missing or unsigned is the "
        "finding, and a Microsoft-signed one in a system location usually is not. A Startup folder shortcut is "
        "reported as the shortcut and its target is not followed. Names, commands and paths are attacker-controlled. "
        AT_UNTRUSTED_NOTE AT_PAGE_NOTE "\","
        "\"inputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"name_contains\":{\"type\":\"string\",\"description\":\"Case-insensitive substring of the entry name or command\"},"
        "\"kind\":{\"type\":\"string\",\"description\":\"Only entries of this kind; the kind field lists the values\"},"
        "\"verify\":{\"type\":\"boolean\",\"description\":\"Check the signature of each image that exists. Off by default "
        "and SLOW: one catalog lookup hashes a whole image and can take a minute on a large third-party binary, so "
        "narrow the list with kind or name_contains first, or verify one file with verify_file_signature\"},"
        AT_PAGE_INPUT_PROPERTIES
        "},\"additionalProperties\":false},"
        "\"outputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"entries\":{\"type\":\"array\",\"items\":{\"type\":\"object\",\"properties\":{"
        "\"name\":{\"type\":[\"string\",\"null\"]},"
        "\"command\":{\"type\":[\"string\",\"null\"],\"description\":\"The text the entry holds - a command line, a module "
        "name, a package name or a class identifier - exactly as it was written\"},"
        ...
        "\"kind\":{\"type\":\"string\",\"description\":\"registry_run, registry_run_once, startup_folder, winlogon, "
        "winlogon_notify, ifeo_debugger, appinit_dll, lsa_package, known_dll, print_monitor, shell_hook, "
        "browser_helper_object or active_setup\"},"
        "\"image_path\":{\"type\":[\"string\",\"null\"],\"description\":\"The file the entry runs or loads. A full path when "
        "it was found; otherwise the name as written, with image_exists false. Null when the entry names no file\"},"
        "\"image_exists\":{\"type\":[\"boolean\",\"null\"],\"description\":\"Whether image_path is on disk; null when no file "
        "could be worked out from the entry\"},"
        "\"verify_result\":{\"type\":[\"string\",\"null\"],\"description\":\"Trusted, No signature, Expired certificate, "
        "Revoked certificate, Not trusted, Security policy failure or Invalid hash. Null unless verify was asked for, "
        "and null for a file that is missing - a missing file is not an unsigned one\"},"
        "\"verify_signer\":{\"type\":[\"string\",\"null\"]},"
        "\"enabled\":{\"type\":[\"boolean\",\"null\"],\"description\":\"For a kind with a switch of its own: AppInit_DLLs "
    ...
    },
    {
        ...
        "\"inputSchema\":{\"type\":\"object\",\"properties\":{},\"additionalProperties\":false},"
        "\"outputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"tbs_available\":{\"type\":\"boolean\",\"description\":\"Whether TPM Base Services could be asked at all. False means the question went unanswered, not that there is no TPM\"},"
        "\"present\":{\"type\":[\"boolean\",\"null\"],\"description\":\"True when TPM Base Services reports a TPM, false only when it reports there is none, null when it could not be asked or failed for another reason\"},"
        "\"error_code\":{\"type\":[\"string\",\"null\"],\"description\":\"The TBS status when the query failed\"},"
        "\"version\":{\"type\":[\"string\",\"null\"],\"description\":\"1.2, 2.0 or unknown; null when the TPM was not read\"},"
        "\"interface_type\":{\"type\":[\"string\",\"null\"],\"description\":\"hardware, trustzone, emulator, spb, port_or_mmio or unknown; null when the TPM was not read\"},"
        "\"implementation_revision\":{\"type\":[\"integer\",\"null\"]},"
    ...
    },
    {
        ...
        "\"inputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"path\":{\"type\":\"string\",\"description\":\"A file or directory, as an absolute Win32 path beginning with a drive letter, or a registry key such as HKLM\\\\Software\\\\...\"},"
        "\"type\":{\"type\":\"string\",\"description\":\"file or registry, when a path is ambiguous; with sddl, the object type whose rights the masks should be read against, e.g. File, Key, Process, Thread, Service, Section, Event. A type that is not one of the known ones is not refused: the masks are then decoded against the standard rights alone, and access_type still echoes what was asked for\"},"
        ...
        "\"path\":{\"type\":[\"string\",\"null\"]},"
        "\"pid\":{\"type\":[\"integer\",\"null\"],\"description\":\"The process that was read; null for every other kind, including a thread\"},"
        "\"tid\":{\"type\":[\"integer\",\"null\"],\"description\":\"The thread that was read; null for every other kind\"},"
    ...
    },
    {
        ...
        "\"inputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"path\":{\"type\":\"string\",\"description\":\"The directory, as an absolute Win32 path beginning with a drive letter\"},"
    ...
    },
    {
        ...
        "\"base_driver\":{\"type\":[\"object\",\"null\"],\"description\":\"The driver of the device at the bottom of the attachment chain; null for a driver path, and null when it could not be opened\",\"properties\":{"
        "\"name\":{\"type\":[\"string\",\"null\"]},"
        "\"image_file_name\":{\"type\":[\"string\",\"null\"]},"
        "\"image_path\":{\"type\":[\"string\",\"null\"]},"
        "\"service_key_name\":{\"type\":[\"string\",\"null\"]},"
    ...
    },
    {
        ...
        "before anything could tamper with it, whether its image verified, and what it has loaded since. Those "
        "first two are in state_names, along with the rest of the driver's own state for the process. READ "
        "state_names AS THE DRIVER'S VOCABULARY, NOT AS FACTS ABOUT THE PROCESS: securely_created, "
        "verified_process and protected_process describe the trust relationship the driver has with a process it "
        "is protecting, and are set only for System Informer's own processes. protected_process in particular "
        "means the driver is protecting it and has nothing to do with a Windows protected process (PPL) - "
        "get_process reports that one, as is_protected_process. image_load_counts separates Microsoft, antimalware, verified and untrusted "
    ...
    },
    {
        ...
        "\"settings\":{\"type\":[\"object\",\"null\"],\"properties\":{\"allow_demand_start\":{\"type\":\"boolean\"},\"allow_hard_terminate\":{\"type\":\"boolean\"},\"compatibility\":{\"type\":\"string\"},\"delete_expired_task_after\":{\"type\":[\"boolean\",\"null\"]},\"disallow_start_if_on_batteries\":{\"type\":\"boolean\"},\"execution_time_limit\":{\"type\":\"string\"},\"multiple_instances\":{\"type\":\"string\"},\"priority\":{\"type\":\"integer\"},\"restart_interval\":{\"type\":[\"string\",\"null\"]},\"run_only_if_idle\":{\"type\":\"boolean\"},\"run_only_if_network_available\":{\"type\":\"boolean\"},\"start_when_available\":{\"type\":\"boolean\"},\"stop_if_going_on_batteries\":{\"type\":\"boolean\"},\"wake_to_run\":{\"type\":\"boolean\"}},\"description\":\"Only with include_details\"}"
    ...
    // files and memory
    {
        ...
        AT_UNTRUSTED_NOTE "\","
        "\"inputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"path\":{\"type\":\"string\",\"description\":\"Absolute Win32 path of the file to verify, beginning with a drive letter\"},"
        "\"include_chain\":{\"type\":\"boolean\",\"description\":\"Return each signature's signing certificate in signatures[]; default false\"},"
        AT_PAGE_INPUT_PROPERTIES
        "},\"required\":[\"path\"],\"additionalProperties\":false},"
        "\"outputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"path\":{\"type\":\"string\"},"
        "\"verification_ran\":{\"type\":\"boolean\",\"description\":\"The trust check actually ran. False when it could not be started at all, and then verify_result and is_trusted are null rather than a verdict the file never got\"},"
        "\"verify_result\":{\"type\":[\"string\",\"null\"],\"description\":\"Trusted, No signature, Expired certificate, Revoked certificate, Not trusted, Security policy failure or Invalid hash. Null when verification_ran is false\"},"
        "\"is_trusted\":{\"type\":[\"boolean\",\"null\"]},"
        "\"signer\":{\"type\":[\"string\",\"null\"]},"
        ...
        "\"has_embedded_signature\":{\"type\":[\"boolean\",\"null\"],\"description\":\"The file carries a signature of its own. Null when the file could not be mapped to look\"},"
        "\"signature_source\":{\"type\":[\"string\",\"null\"],\"enum\":[\"embedded\",\"catalog\",null],"
        "\"description\":\"catalog means trusted with no signature of its own, which can only be said once both halves are known; null when either is not\"},"
        "\"is_pe_image\":{\"type\":[\"boolean\",\"null\"],\"description\":\"False for a file that is not a PE image, which can only be catalog signed; null when the file could not be mapped\"},"
    ...
    },
    {
        ...
        AT_UNTRUSTED_NOTE "\","
        "\"inputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"path\":{\"type\":\"string\",\"description\":\"Absolute Win32 path of the file, beginning with a drive letter\"},"
    ...
    },
    {
        ...
        "\"path\":{\"type\":\"string\",\"description\":\"Absolute Win32 path, beginning with a drive letter, of a file to hash and then look up when the hash is not already known. The file itself is never sent\"},"
    ...
    },
    {
        ...
        "\"inputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"sha256\":{\"type\":\"string\",\"description\":\"The file's SHA-256 as hex, from get_file_hashes\"},"
        "\"path\":{\"type\":\"string\",\"description\":\"Absolute Win32 path, beginning with a drive letter, of a file to hash and then look up when the hash is not already known\"}"
        "},\"additionalProperties\":false},"
        "\"outputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"sha256\":{\"type\":\"string\"},"
        "\"path\":{\"type\":[\"string\",\"null\"]},"
    ...
    },
    {
        ...
        AT_UNTRUSTED_NOTE "\","
        "\"inputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"path\":{\"type\":\"string\",\"description\":\"Absolute Win32 path of the file or directory, beginning with a drive letter\"},"
    ...
    },
    {
        ...
        AT_UNTRUSTED_NOTE "\","
        "\"inputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"path\":{\"type\":\"string\",\"description\":\"Absolute Win32 path of the image file, beginning with a drive letter\"},"
        ...
        "\"dos\":{\"type\":\"object\",\"properties\":{\"e_lfanew\":{\"type\":\"integer\"}}},\"file\":{\"type\":\"object\",\"properties\":{\"characteristics\":{\"type\":\"array\"},\"machine\":{\"type\":\"string\"},\"machine_value\":{\"type\":\"string\"},\"number_of_sections\":{\"type\":\"integer\"},\"number_of_symbols\":{\"type\":\"integer\"},\"size_of_optional_header\":{\"type\":\"integer\"}}},\"optional\":{\"type\":\"object\",\"properties\":{\"address_of_entry_point\":{\"type\":\"string\"},\"base_of_code\":{\"type\":\"string\"},\"checksum\":{\"type\":\"string\"},\"file_alignment\":{\"type\":\"integer\"},\"image_base\":{\"type\":\"string\"},\"image_version_major\":{\"type\":\"integer\"},\"image_version_minor\":{\"type\":\"integer\"},\"linker_version_major\":{\"type\":\"integer\"},\"linker_version_minor\":{\"type\":\"integer\"},\"magic\":{\"type\":\"string\"},\"number_of_rva_and_sizes\":{\"type\":\"integer\"},\"operating_system_version_major\":{\"type\":\"integer\"},\"operating_system_version_minor\":{\"type\":\"integer\"},\"section_alignment\":{\"type\":\"integer\"},\"size_of_code\":{\"type\":\"integer\"},\"size_of_headers\":{\"type\":\"integer\"},\"size_of_heap_commit\":{\"type\":\"integer\"},\"size_of_heap_reserve\":{\"type\":\"integer\"},\"size_of_image\":{\"type\":\"integer\"},\"size_of_initialized_data\":{\"type\":\"integer\"},\"size_of_stack_commit\":{\"type\":\"integer\"},\"size_of_stack_reserve\":{\"type\":\"integer\"},\"size_of_uninitialized_data\":{\"type\":\"integer\"},\"subsystem\":{\"type\":\"string\"},\"subsystem_version_major\":{\"type\":\"integer\"},\"subsystem_version_minor\":{\"type\":\"integer\"}}}}},"
        ...
        "\"imports_count\":{\"type\":\"integer\"},\"imports_total_count\":{\"type\":\"integer\"},"
        "\"imports_offset\":{\"type\":\"integer\"},\"imports_limit\":{\"type\":\"integer\"},"
        "\"imports_truncated\":{\"type\":\"boolean\",\"description\":\"Only this list was cut; each list carries its own paging fields because a tool answering three of them cannot share one set\"},"
        "\"exports_count\":{\"type\":\"integer\"},\"exports_total_count\":{\"type\":\"integer\"},"
        "\"exports_offset\":{\"type\":\"integer\"},\"exports_limit\":{\"type\":\"integer\"},"
        "\"exports_truncated\":{\"type\":\"boolean\",\"description\":\"Only this list was cut; each list carries its own paging fields because a tool answering three of them cannot share one set\"},"
        "\"resources_count\":{\"type\":\"integer\"},\"resources_total_count\":{\"type\":\"integer\"},"
        "\"resources_offset\":{\"type\":\"integer\"},\"resources_limit\":{\"type\":\"integer\"},"
        "\"resources_truncated\":{\"type\":\"boolean\",\"description\":\"Only this list was cut; each list carries its own paging fields because a tool answering three of them cannot share one set\"},"
