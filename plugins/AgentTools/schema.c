...
CONST AT_TOOL AtTools[] =
{
    ...
    },
    {
        ...
        "\"inputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"path\":{\"type\":\"string\",\"description\":\"Absolute Win32 path of the file to ask about, on a local drive\"},"
    ...
    },
    {
        ...
        "\"path\":{\"type\":\"string\",\"description\":\"Resolve against this file instead: an absolute Win32 path on a local drive\"},"
    ...
    },
    {
        ...
        "\"inputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"path\":{\"type\":\"string\",\"description\":\"The directory, as an absolute Win32 path on a local drive\"},"
    ...
    // files and memory
    {
        ...
        AT_UNTRUSTED_NOTE "\","
        "\"inputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"path\":{\"type\":\"string\",\"description\":\"Absolute Win32 path of the file to verify, on a local drive\"},"
    ...
    },
    {
        ...
        AT_UNTRUSTED_NOTE "\","
        "\"inputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"path\":{\"type\":\"string\",\"description\":\"Absolute Win32 path of the file, on a local drive\"},"
    ...
    },
    {
        ...
        "\"path\":{\"type\":\"string\",\"description\":\"Absolute Win32 path, on a local drive, of a file to hash and then look up when the hash is not already known. The file itself is never sent\"},"
    ...
    },
    {
        ...
        "\"inputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"sha256\":{\"type\":\"string\",\"description\":\"The file's SHA-256 as hex, from get_file_hashes\"},"
        "\"path\":{\"type\":\"string\",\"description\":\"Absolute Win32 path, on a local drive, of a file to hash and then look up when the hash is not already known\"}"
        "},\"additionalProperties\":false},"
        "\"outputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"sha256\":{\"type\":\"string\"},"
        "\"path\":{\"type\":[\"string\",\"null\"]},"
    ...
    },
    {
        ...
        AT_UNTRUSTED_NOTE "\","
        "\"inputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"path\":{\"type\":\"string\",\"description\":\"Absolute Win32 path of the file or directory, on a local drive\"},"
    ...
    },
    {
        ...
        AT_UNTRUSTED_NOTE "\","
        "\"inputSchema\":{\"type\":\"object\",\"properties\":{"
        "\"path\":{\"type\":\"string\",\"description\":\"Absolute Win32 path of the image file, on a local drive\"},"
