...
// private
typedef UINT32 RTL_FEATURE_ID;
typedef UINT64 RTL_FEATURE_CHANGE_STAMP, *PRTL_FEATURE_CHANGE_STAMP;
typedef UCHAR RTL_FEATURE_VARIANT;
typedef UINT32 RTL_FEATURE_VARIANT_PAYLOAD;
...
{
    ULONG FeatureCount;
    RTL_FEATURE_CONFIGURATION Features[ANYSIZE_ARRAY];
...
typedef struct _RTL_FEATURE_USAGE_SUBSCRIPTION_TABLE
{
    ...
    RTL_FEATURE_USAGE_SUBSCRIPTION_DETAILS Subscriptions[ANYSIZE_ARRAY];
...
typedef struct _SYSTEM_FEATURE_CONFIGURATION_UPDATE
{
    ...
    union
    {
        struct
        {
            ...
            RTL_FEATURE_CONFIGURATION_TYPE ConfigurationType;
            ULONG UpdateCount;
            RTL_FEATURE_CONFIGURATION_UPDATE Updates[ANYSIZE_ARRAY];
        } Update;
...
{
    ULONG UpdateCount;
    SYSTEM_FEATURE_USAGE_SUBSCRIPTION_UPDATE_ENTRY Updates[ANYSIZE_ARRAY];
