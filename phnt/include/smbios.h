...
#define SMBIOS_PROCESSOR_FLAG_MULTI_CORE                ((USHORT)0x0008)
...
#define SMBIOS_IPMI_INTERFACE_TYPE_UNKNOWN      ((UCHAR)0)
...
#define SMBIOS_ONBOARD_DEVICE_TYPE_NVME         ((UCHAR)15)
...
#define SMBIOS_STRING_PROPERTY_ID_UEFI_DEVICE_PATH  ((UCHAR)2)
