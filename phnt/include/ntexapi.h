...
static_assert(SYSTEM_STORE_TRIM_INFORMATION_SIZE == sizeof(SM_SYSTEM_STORE_TRIM_REQUEST), "SYSTEM_STORE_TRIM_INFORMATION_SIZE must equal SM_STORE_TRIM_INFORMATION_SIZE");
...
static_assert(SYSTEM_STORE_COMPRESSION_INFORMATION_SIZE_V1 == 40, "SM_STORE_COMPRESSION_INFORMATION_REQUEST_V1 must equal SIZE_V1");
static_assert(SYSTEM_STORE_COMPRESSION_INFORMATION_SIZE_V2 == 48, "SM_STORE_COMPRESSION_INFORMATION_REQUEST_V2 must equal SIZE_V2");
static_assert(SYSTEM_STORE_COMPRESSION_INFORMATION_SIZE == sizeof(SM_STORE_COMPRESSION_INFORMATION_REQUEST), "SYSTEM_STORE_COMPRESSION_INFORMATION_SIZE must equal SM_STORE_COMPRESSION_INFORMATION_REQUEST");
